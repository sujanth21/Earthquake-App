...
/**
 * Created by Sujanth on 2/24/2017.
 */
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //creating a json object from the string lists
            JSONObject earthquake_list = new JSONObject(SAMPLE_JSON_RESPONSE);

            JSONArray feature_list = earthquake_list.getJSONArray("features");

            for (int x=0; x < feature_list.length(); x++) {
                JSONObject feature = feature_list.getJSONObject(x);
